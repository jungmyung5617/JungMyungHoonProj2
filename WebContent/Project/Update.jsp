    ...
    <div class="container">
    	...
    	<div class="row">
				<div class="col-md-offset-1 col-md-10">
					<form class="form-horizontal" action="<c:url value="/Project/Update.kosmo"/>" method="post">
						<input style="display: none" name="no" value="${param.no}" /> <!-- //style 요소 중에 display : none 이 있어요 이거 한 번 써보세용!! -->
						<table>
							<tr bgcolor="white">
